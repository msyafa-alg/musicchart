...
<head>
    ...
    <title>Add Album - MusicChart Admin</title>
...
<body class="min-h-screen antialiased">
    ...
    <div class="max-w-2xl mx-auto px-6 py-8">
        ...
        <div class="mb-8">
            <h1 class="text-4xl font-black text-white mb-2">
                Add New <span class="gradient-text">Album</span>
            </h1>
            <p class="text-gray-400">Create a new music album for your collection</p>
        </div>
            ...
            <form action="{{ route('albums.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <select name="artist_id" id="artist_id" required
                        ...
                        @foreach($artists as $artist)
                            <option value="{{ $artist->id }}" class="text-gray-700">{{ $artist->name }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="mb-6">
                    <label for="cover" class="form-label">
                        <i class="fas fa-image text-yellow-400 mr-2"></i>Album Cover
                    </label>
 ...
 <input type="file" name="cover" id="cover" accept="image/*"
                        ...
                        {{-- <div class="flex flex-col items-center space-y-3">
                            ...
                            <div>
                                <p class="text-white font-medium">Click to upload cover image</p>
                ...
                <div class="mb-8">
                    ...
                    <input type="number" name="popularity" id="popularity" min="0" max="100" value="0"
                           class="input-field w-full px-4 py-3 text-white">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="w-full bg-gray-700 rounded-full h-2">
                            <div id="popularity-preview" class="bg-gradient-to-r from-orange-400 to-red-500 h-2 rounded-full transition-all duration-300" style="width: 0%"></div>
                        </div>
                    </div>
                </div>
