...
<head>
    ...
    <title>Add Song - MusicChart Admin</title>
...
<body class="min-h-screen antialiased">
    ...
    <div class="max-w-2xl mx-auto px-6 py-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-400">Create a new song in your music collection</p>
        </div>
        ...
        <div class="glass-card rounded-2xl p-8">
            <form action="{{ route('songs.store') }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <select name="artist_id" id="artist_id" required
                        ...
                        @foreach($artists as $artist)
                            <option value="{{ $artist->id }}" class="bg-gray-800">{{ $artist->name }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <select name="album_id" id="album_id" required
                        ...
                        @foreach($albums as $album)
                            <option value="{{ $album->id }}" class="bg-gray-800">
                ...
                <div class="mb-8">
                    ...
                    <p class="form-hint text-sm mt-2">Example: 180 seconds = 3 minutes</p>
                </div>
